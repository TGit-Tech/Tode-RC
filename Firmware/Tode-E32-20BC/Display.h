...
//Uncomment the Display Type (Pins identified in Intializer)
#define ADAFRUIT_GFX
...
#define ITEMCHARWIDTH 6
#define ITEMCHARHEIGHT 13
...
#define PINK 0xF81F
//---[ FORMAT ]---------------------------------------------------------
#define HIGHLIGHT setTextColor(YELLOW)
#define NORMAL setTextColor(WHITE, BLACK)
#endif
//^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
