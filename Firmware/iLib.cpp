...
//-----------------------------------------------------------------------------------------------------
void MenuName::DispItem(byte _XPos, byte _YPos) {
...
//---------------------------------------------------------------------------------------------------------------------
int MenuValue::Value() {                                      DBENTERAL(("MenuValue::Value(GET): "),(iValue)) 
  return iValue; 
}
//-----------------------------------------------------------------------------------------------------
void MenuValue::Value(int _Value, byte _Status = STSNORMAL) { DBENTERAAL(("MenuValue::Value(SET,STS): "),(_Value),(_Status,HEX))
  iValue = _Value; bStatus = _Status;
}
//---------------------------------------------------------------------------------------------------------------------
...
//-----------------------------------------------------------------------------------------------------
void MenuValue::DispItem(byte _XPos, byte _YPos) {
  if (_XPos!=0) XPos=_XPos; if (_YPos!=0) YPos=_YPos;
  OnDisplay(true);
...
//-----------------------------------------------------------------------------------------------------
void MenuEEValue::Value(int _Value, byte _Status) {                   DBENTERAL(("MenuEEValue::Value[SET]"),(_Value))
