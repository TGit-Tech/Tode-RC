...
///@}
/******************************************************************************//**
 * @defgroup VST VST - Value Set Types
 * @{
 *********************************************************************************/
#define VST_BYUSER     0
#define VST_BYRX       1
...
class MenuName : public MenuItem {
  ...
  protected:
    ...
    virtual void          Show(byte _XPos=0, byte _YPos=0) override;  ///< Display the Item
  ...
  private:
    ...
    byte          Type=0;
    byte          Size=0;
    byte          SetIdx = 0;               ///< Set-To Array[] current RFID
};
/******************************************************************************************************************//**
 * @class   MenuValue
...
class MenuValue : public MenuName {
  ...
  protected:
    ...
    virtual byte          NavNone(byte _Key) override;        ///< NONE Navigate
...
class MenuEEValue : public MenuValue {
  public:
    ...
    virtual void          Value(int _Value) override;                   ///< SET Item Value
