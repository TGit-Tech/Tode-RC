...
//-----------------------------------------------------------------------------------------------------
void RadioAddress::Value(int _Value) {                 DBENTERAL(("RadioAddress::Value[SET]"),(_Value))
...
//-----------------------------------------------------------------------------------------------------    
void RadioFrequency::Value(int _Value) {
...
//-----------------------------------------------------------------------------------------------------    
void RadioTxPower::Value(int _Value) { 
...
//-----------------------------------------------------------------------------------------------------
void RadioPCConn::Value(int _Value) { 
  iValue=_Value;
