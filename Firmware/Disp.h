...
//---[ OBJECT ]---------------------------------------------------------
static DSPCLASS oDisplay = DSPCLASS(49, 47, 23);            //TFT(cs, dc(rs)(cd), rst)
...
#define BGNAMESELT fillRect(XPos,YPos-ITEMCHARHEIGHT+2,VALCOL,ITEMCHARHEIGHT,BLUE)
#define BGNAMENORM fillRect(XPos,YPos-ITEMCHARHEIGHT+2,VALCOL,ITEMCHARHEIGHT,BLACK)
#define BGVALSELT fillRect(XPos+VALCOL,YPos-ITEMCHARHEIGHT+2,SCREENWIDTH-VALCOL,ITEMCHARHEIGHT,BLUE)
